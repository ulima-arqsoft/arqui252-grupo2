...
**Sustento:**  
**Sustento**
- Simplicidad de integración con Node.js.
- Rendimiento en entornos de microservicios o de baja concurrencia.
- No requiere infraestructura adicional (como un servidor Redis externo).
...
**Sustento:**  
**Conclusión**
Node-Cache proporciona una solución práctica, eficiente y de rápida implementación para el entorno actual del sistema, que opera bajo una arquitectura de microservicios. Su simplicidad permite reducir la latencia de respuesta en el dashboard sin añadir complejidad a la infraestructura. Además, esta elección no compromete la escalabilidad futura, ya que la lógica de caché puede migrarse fácilmente a Redis cuando el sistema evolucione hacia una arquitectura distribuida o requiera persistencia del caché.
