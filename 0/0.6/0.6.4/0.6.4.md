...
## Detalle de Configuración del Ejemplo: Demo

Esta sección describe la implementación práctica de API Management utilizando **Azure Container Apps** para el despliegue de servicios y **Kong Gateway** como API Gateway. La demo ilustra cómo configurar un sistema completo de gestión de APIs con autenticación JWT y control CORS.
