...
| ESC-06 | Mantenibilidad | Equipo desarrollo | Cambio en lógica de validación de usuarios | Arquitectura modular con microservicios | Desarrollo | Despliegue del cambio sin afectar otros módulos | Implementación <4 horas + 0 downtime |
...
| ESC-18 | Disponibilidad | Error en despliegue | Caída simultánea de servicios (admin, reseñas, perfiles) | Kubernetes con healthchecks cada 10s | Producción | Detección de fallas y restart automático por módulo | Recuperación <30s por módulo |
