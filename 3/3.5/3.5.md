...
| ESC-06 | Mantenibilidad | Equipo desarrollo | Cambio en lógica de validación de usuarios | Backend de microservicios con componentes modulares | Desarrollo | Despliegue del cambio sin afectar otros módulos | Implementación <4 horas + 0 downtime |
...
| ESC-18 | Disponibilidad | Error en despliegue | Caída de un servicio del backend de microservicios | Infraestructura con monitor automático (PM2/Supervisor) | Producción | Detección de falla y restart automático del proceso | Recuperación <30s |
